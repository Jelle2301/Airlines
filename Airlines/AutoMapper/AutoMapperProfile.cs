        ...
        public AutoMapperProfile()
        {
            ...
            CreateMap<VluchtVM, Vlucht>()
                .ForMember(dest => dest.Prijs,
                    opts => opts.MapFrom(
                        src => src.BeginPrijs))
                .ForMember(dest => dest.Vliegtuig.VliegtuigNaam,
                    opts => opts.MapFrom(
                        src => src.VliegtuigNaam))
                .ForMember(dest => dest.Vliegtuig.AantalTotalePlaatsen,
                    opts => opts.MapFrom(
                        src => src.AantalTotalePlaatsen))
                .ForMember(dest => dest.Vliegtuig.AantalGewonePlaatsen,
                    opts => opts.MapFrom(
                        src => src.AantalGewonePlaatsen))
                .ForMember(dest => dest.Vliegtuig.AantalBusinessPlaatsen,
                    opts => opts.MapFrom(
                        src => src.AantalBusinessPlaatsen))
                .ForMember(dest => dest.Vliegtuig.AantalEconomyPlaatsen,
                    opts => opts.MapFrom(
                        src => src.AantalEconomyPlaatsen))
                .ForMember(dest => dest.Vertrekplaats.Plaats.Naam,
                    opts => opts.MapFrom(
                        src => src.VertrekNaam))
                /*.ForMember(dest => dest.OverstapNaam,
                    opts => opts.MapFrom(
                        src => src.Overstap.Plaats.Naam))*/
                .ForMember(dest => dest.Bestemming.Plaats.Naam,
                    opts => opts.MapFrom(
